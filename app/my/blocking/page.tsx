...
export default function BlockingPage() {
  ...
  return (
    <Screen className="relative">
      ...
      {toast && (
        <div className="fixed left-1/2 -translate-x-1/2 bottom-[60px] z-50 max-w-[296px] w-max px-5 py-3 bg-black/74 text-white text-[13px] rounded-[8px] text-center whitespace-pre-line">
          {toast}
        </div>
      )}
    </Screen>
