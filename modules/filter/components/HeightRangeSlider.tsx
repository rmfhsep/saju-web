...
// 디자인 시스템 Slider(142-112): track Navy100(#F4F4F5), fill/thumb-border Light Blue Heavy(#90B7FF)
const THUMB_CLASS =
  ...
  "[&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-[#90b7ff] " +
  ...
  "[&::-moz-range-thumb]:bg-white [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-[#90b7ff]"
...
export default function HeightRangeSlider({ min, max, valueMin, valueMax, onChange }: Props) {
  ...
  return (
    <div className="relative h-[24px]">
      <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-[4px] rounded-full bg-[#f4f4f5]" />
      <div
        className="absolute top-1/2 -translate-y-1/2 h-[4px] rounded-full bg-[#90b7ff]"
